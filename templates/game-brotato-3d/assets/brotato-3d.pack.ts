...
const assets = {
  'texture/glow-mask': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000021'),
    kind: 'texture',
    name: `${PACKAGE_NAME} / Glow Mask`,
  },
  'material/arena-floor': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000001'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Arena Floor`,
  },
  'material/arena-tile-a': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000002'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Arena Tile A`,
  },
  'material/arena-tile-b': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000003'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Arena Tile B`,
  },
  'material/arena-wall': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000004'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Arena Wall`,
  },
  'material/player': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000005'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Player`,
  },
  'material/player-hit': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000006'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Player Hit`,
  },
  'material/weapon': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000007'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Weapon`,
  },
  'material/weapon-accent': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000013'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Weapon Accent`,
  },
  'material/enemy': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000008'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Enemy`,
  },
  'material/elite': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000009'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Elite Enemy`,
  },
  'material/projectile': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000010'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Projectile`,
  },
  'material/pickup': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000011'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Pickup`,
  },
  'material/vfx': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000012'),
    kind: 'material',
    name: `${PACKAGE_NAME} / Impact VFX`,
  },
  'mesh/arena-floor': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000030'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Arena Floor Mesh`,
  },
  'mesh/arena-field-a': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000040'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Arena Tile Field A`,
  },
  'mesh/arena-field-b': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000041'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Arena Tile Field B`,
  },
  'mesh/arena-wall': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000032'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Arena Wall Mesh`,
  },
  'mesh/player': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000033'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Player Mesh`,
  },
  'mesh/weapon': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000034'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Weapon Mesh`,
  },
  'mesh/enemy': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000035'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Enemy Mesh`,
  },
  'mesh/elite': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000036'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Elite Mesh`,
  },
  'mesh/projectile': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000037'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Projectile Mesh`,
  },
  'mesh/pickup': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000038'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Pickup Mesh`,
  },
  'mesh/arena-marker': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000039'),
    kind: 'mesh',
    name: `${PACKAGE_NAME} / Arena Marker Mesh`,
  },
  'scene/arena': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000050'),
    kind: 'scene',
    name: `${PACKAGE_NAME} / Arena Level`,
  },
  'scene/player': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000051'),
    kind: 'scene',
    name: `${PACKAGE_NAME} / Player Prefab`,
  },
  'scene/enemy': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000052'),
    kind: 'scene',
    name: `${PACKAGE_NAME} / Enemy Prefab`,
  },
  'scene/boss': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000056'),
    kind: 'scene',
    name: `${PACKAGE_NAME} / Boss Prefab`,
  },
  'scene/weapon': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000053'),
    kind: 'scene',
    name: `${PACKAGE_NAME} / Weapon Prefab`,
  },
  'scene/projectile': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000054'),
    kind: 'scene',
    name: `${PACKAGE_NAME} / Projectile Prefab`,
  },
  'scene/pickup': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000055'),
    kind: 'scene',
    name: `${PACKAGE_NAME} / Pickup Prefab`,
  },
  'vfx/impact': {
    guid: parseGuid('019fb264-3000-7000-8000-000000000070'),
    kind: 'particle-effect',
    name: `${PACKAGE_NAME} / Impact Burst`,
  },
} as const satisfies ScriptablePackAssetDeclarations;

const IMPACT_VFX_SOURCE_GUID = parseGuid('019fb264-3000-7000-8000-000000000079');
...
function particleMaterial(): MaterialAsset {
  return {
    kind: 'material',
    passes: [
      {
    ...
    values: {
      baseColor: [0.1, 0.65, 1, 1],
      emissive: [0.05, 0.55, 1],
      emissiveIntensity: 8,
      roughness: 0.25,
      clearcoat: 0.15,
    },
...
function arenaScene(fieldA: AssetGuidType, fieldB: AssetGuidType): SceneAsset {
  const entities: SceneEntity[] = [
    node(0, 'Arena Floor', assets['mesh/arena-floor'].guid, [assets['material/arena-floor'].guid], [0, -0.28, 0], [1, 1, 1]),
    {
    ...
    node(5, 'Arena Tile Field A', fieldA, [assets['material/arena-tile-a'].guid], [0, 0, 0], [1, 1, 1]),
    node(6, 'Arena Tile Field B', fieldB, [assets['material/arena-tile-b'].guid], [0, 0, 0], [1, 1, 1]),
  ];
  let localId = 7;
  ...
  for (const [name, pos, scale, quat] of walls) {
    entities.push(node(localId, name, assets['mesh/arena-wall'].guid, [assets['material/arena-wall'].guid], pos, scale, quat));
    localId += 1;
  }
  for (const [x, z] of [[-12.2, -12.2], [12.2, -12.2], [-12.2, 12.2], [12.2, 12.2]] as const) {
    entities.push(node(localId, 'Arena Marker', assets['mesh/arena-marker'].guid, [assets['material/weapon'].guid], [x, 0.08, z], [1, 1, 1]));
    localId += 1;
  }
...
const scriptablePack = {
  schemaVersion: '1.0.0',
  packageId: parseGuid('019fb264-3000-7000-8000-000000000000'),
  name: PACKAGE_NAME,
  assets,
  sceneComponents: [
    DirectionalLight,
  ...
  externalAssets: { impactVfx: IMPACT_VFX_SOURCE_GUID, skyEquirect: SKY_EQUIRECT_SOURCE_GUID },
  async build(assetReader: AssetReader) {
    ...
    const impactVfx = await assetReader.readByGuid<ParticleEffectAsset>(IMPACT_VFX_SOURCE_GUID);
    if (!impactVfx.ok) {
      return err(
        new AssetError({
    ...
    const materialFloor = assets['material/arena-floor'].guid;
    const materialTileA = assets['material/arena-tile-a'].guid;
    const materialWall = assets['material/arena-wall'].guid;
    const materialPlayer = assets['material/player'].guid;
    const materialWeapon = assets['material/weapon'].guid;
    const materialWeaponAccent = assets['material/weapon-accent'].guid;
    const materialEnemy = assets['material/enemy'].guid;
    const materialElite = assets['material/elite'].guid;
    const materialProjectile = assets['material/projectile'].guid;
    const materialPickup = assets['material/pickup'].guid;
    ...
    return ok({
      ...
      'mesh/arena-field-b': bindMaterialSlots(arenaFieldB, [assets['material/arena-tile-b'].guid], 'arena-field-b'),
      ...
      'scene/arena': arenaScene(assets['mesh/arena-field-a'].guid, assets['mesh/arena-field-b'].guid),
      'scene/player': actorScene('Brotato Player', assets['mesh/player'].guid, [materialPlayer, materialWeapon], [0.72, 0.72, 0.72]),
      'scene/enemy': actorScene('Brotato Enemy', assets['mesh/enemy'].guid, [materialEnemy, materialWeapon], [0.62, 0.62, 0.62]),
      'scene/boss': actorScene('Brotato Boss', assets['mesh/elite'].guid, [materialElite, materialWeapon], [0.86, 0.86, 0.86]),
      'scene/weapon': actorScene('Brotato Weapon', assets['mesh/weapon'].guid, [materialWeapon, materialWeaponAccent], [0.92, 0.92, 0.92]),
      'scene/projectile': actorScene('Brotato Projectile', assets['mesh/projectile'].guid, [materialProjectile, materialWeaponAccent], [0.42, 0.42, 0.42]),
      'scene/pickup': actorScene('Brotato Pickup', assets['mesh/pickup'].guid, [materialPickup], [0.3, 0.22, 0.3]),
      'vfx/impact': impactVfx.value,
    } satisfies ScriptablePackOutputs<typeof assets>);
  },
} satisfies ScriptablePackDefinition<
  typeof assets,
  { readonly impactVfx: typeof IMPACT_VFX_SOURCE_GUID; readonly skyEquirect: typeof SKY_EQUIRECT_SOURCE_GUID },
  AssetError
>;
