...
const BROTATO_ASSET_GUIDS = {
  textureGlowMask: '019fb264-3000-7000-8000-000000000021',
  materialArenaFloor: '019fb264-3000-7000-8000-000000000001',
  materialArenaTileA: '019fb264-3000-7000-8000-000000000002',
  materialArenaTileB: '019fb264-3000-7000-8000-000000000003',
  materialArenaWall: '019fb264-3000-7000-8000-000000000004',
  materialPlayer: '019fb264-3000-7000-8000-000000000005',
  materialPlayerHit: '019fb264-3000-7000-8000-000000000006',
  materialWeapon: '019fb264-3000-7000-8000-000000000007',
  materialWeaponAccent: '019fb264-3000-7000-8000-000000000013',
  materialEnemy: '019fb264-3000-7000-8000-000000000008',
  materialElite: '019fb264-3000-7000-8000-000000000009',
  materialProjectile: '019fb264-3000-7000-8000-000000000010',
  materialPickup: '019fb264-3000-7000-8000-000000000011',
  materialVfx: '019fb264-3000-7000-8000-000000000012',
  meshArenaFloor: '019fb264-3000-7000-8000-000000000030',
  meshArenaFieldA: '019fb264-3000-7000-8000-000000000040',
  meshArenaFieldB: '019fb264-3000-7000-8000-000000000041',
  meshArenaWall: '019fb264-3000-7000-8000-000000000032',
  meshPlayer: '019fb264-3000-7000-8000-000000000033',
  meshWeapon: '019fb264-3000-7000-8000-000000000034',
  meshEnemy: '019fb264-3000-7000-8000-000000000035',
  meshElite: '019fb264-3000-7000-8000-000000000036',
  meshProjectile: '019fb264-3000-7000-8000-000000000037',
  meshPickup: '019fb264-3000-7000-8000-000000000038',
  sceneArena: '019fb264-3000-7000-8000-000000000050',
  scenePlayer: '019fb264-3000-7000-8000-000000000051',
  sceneEnemy: '019fb264-3000-7000-8000-000000000052',
  sceneWeapon: '019fb264-3000-7000-8000-000000000053',
  uiHud: '019fb264-3000-7000-8000-000000000090',
  vfxImpact: '019fb264-3000-7000-8000-000000000070',
} as const;
...
async function loadMaterials(world: World, assets: AssetRegistry): Promise<BrotatoMaterials> {
  const [floor, tileA, tileB, wall, player, playerHit, weapon, weaponAccent, enemy, elite, projectile, pickup, vfx] = await Promise.all([
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialArenaFloor),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialArenaTileA),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialArenaTileB),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialArenaWall),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialPlayer),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialPlayerHit),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialWeapon),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialWeaponAccent),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialEnemy),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialElite),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialProjectile),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialPickup),
    loadMaterial(world, assets, BROTATO_ASSET_GUIDS.materialVfx),
  ]);
...
async function loadMeshes(world: World, assets: AssetRegistry): Promise<BrotatoMeshes> {
  const [player, weapon, enemy, elite, projectile, pickup] = await Promise.all([
    loadMesh(world, assets, BROTATO_ASSET_GUIDS.meshPlayer),
    loadMesh(world, assets, BROTATO_ASSET_GUIDS.meshWeapon),
    loadMesh(world, assets, BROTATO_ASSET_GUIDS.meshEnemy),
    loadMesh(world, assets, BROTATO_ASSET_GUIDS.meshElite),
    loadMesh(world, assets, BROTATO_ASSET_GUIDS.meshProjectile),
    loadMesh(world, assets, BROTATO_ASSET_GUIDS.meshPickup),
  ]);
...
async function loadScenes(assets: AssetRegistry): Promise<BrotatoScenes> {
  const [arena, player, enemy, weapon] = await Promise.all([
    loadAsset<SceneAsset>(assets, BROTATO_ASSET_GUIDS.sceneArena, 'scene'),
    loadAsset<SceneAsset>(assets, BROTATO_ASSET_GUIDS.scenePlayer, 'scene'),
    loadAsset<SceneAsset>(assets, BROTATO_ASSET_GUIDS.sceneEnemy, 'scene'),
    loadAsset<SceneAsset>(assets, BROTATO_ASSET_GUIDS.sceneWeapon, 'scene'),
  ]);
...
async function createBrotatoVfx(
  ...
  const loaded = await loadVfxGpuEffect(assets, BROTATO_ASSET_GUIDS.vfxImpact);
  if (!loaded.ok) {
...
export async function createBrotatoGame(
  ...
  const hudAsset = await loadUiAsset(assets, BROTATO_ASSET_GUIDS.uiHud);
