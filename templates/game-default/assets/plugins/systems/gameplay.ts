...
export function installGameplaySystems(ctx: GameplaySystemsContext): void {
  installInputActionsSystem({
    ...
    resetMeshHandleSwap: ctx.resetMeshHandleSwap,
    resetFbxMeshSwap: ctx.resetFbxMeshSwap,
    resetGltfMeshSwap: ctx.resetGltfMeshSwap,
    resetJpegTextureSwap: ctx.resetJpegTextureSwap,
    toggleJpegTextureSwap: ctx.toggleJpegTextureSwap,
  });
