...
const OUTPUT_GUIDS = {
  voidAlloy: '019fb264-1000-7000-8000-000000000001',
  ionCyan: '019fb264-1000-7000-8000-000000000002',
  plasmaViolet: '019fb264-1000-7000-8000-000000000003',
  solarGold: '019fb264-1000-7000-8000-000000000004',
  outerRing: '019fb264-1000-7000-8000-000000000011',
  innerRing: '019fb264-1000-7000-8000-000000000012',
  pylon: '019fb264-1000-7000-8000-000000000013',
  orb: '019fb264-1000-7000-8000-000000000014',
  anchor: '019fb264-1000-7000-8000-000000000015',
  scene: '019fb264-1000-7000-8000-000000000021',
  resonanceAtlas: '019fb264-1000-7000-8000-000000000031',
  resonanceSampler: '019fb264-1000-7000-8000-000000000032',
  animationClip: '019fb264-1000-7000-8000-000000000033',
  animationGraph: '019fb264-1000-7000-8000-000000000034',
  diagnosticAudio: '019fb264-1000-7000-8000-000000000035',
  chargeVfx: '019fb264-1000-7000-8000-000000000036',
} as const;
...
export async function createResonanceForge(
  ...
  const snapshot = (): ResonanceForgeSnapshot => ({
    ...
    outputCount: Object.keys(OUTPUT_GUIDS).length,
    meshCount: 5,
    materialCount: 4,
    sceneCount: 1,
  ...
  try {
    const scene = await loadOutput<SceneAsset>(assets, OUTPUT_GUIDS.scene);
