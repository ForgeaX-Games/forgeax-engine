// apps/learn-render/1.getting-started/4.textures - ambient declarations.
//
...
// (used by the import-pipeline.browser.test.ts test infrastructure -- see
// w14c rationale in that file's header).
