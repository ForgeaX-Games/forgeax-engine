...
try {
  ...
  console.error('  rerun: pnpm --filter @forgeax/shadertoy-fractal-pyramid smoke');
  process.exit(1);
}
...
if (!existsSync(MANIFEST_PATH)) {
  ...
  console.error('  hint: rebuild via `pnpm --filter @forgeax/shadertoy-fractal-pyramid build`');
  process.exit(1);
}
...
shader.registerMaterialShader('shadertoy::fractal-pyramid', {
  source: composedWgsl,
  paramSchema: [
