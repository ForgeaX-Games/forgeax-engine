...
const state = createQueryState({ with: [Entity, SpriteAnimation] });
const animationEntities = [];
queryRun(state, world, (bundle) => { for (const entity of bundle.Entity.self) animationEntities.push(entity); });
