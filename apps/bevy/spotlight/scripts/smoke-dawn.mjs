...
const { Camera, createRenderer, Materials, MeshFilter, MeshRenderer, perspective, SpotLight, Transform } = await import(
...
console.log(`[bevy-spotlight] backend=${renderer.backend}`);
