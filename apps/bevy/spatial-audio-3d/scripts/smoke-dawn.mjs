#!/usr/bin/env node
// Headless structural smoke for spatial_audio_3d.
...
console.log(`[spatial-audio-3d] backend=${app.renderer.backend} frames=${frames} audioResource=${hasAudioEngine} camera=${scene.camera} emitter=${scene.emitter}`);
