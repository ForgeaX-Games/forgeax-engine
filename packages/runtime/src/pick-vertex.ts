...
// ── internal world surface (mirrors pick.ts:63-78) ──────────────────────
...
function collectVertexHits(
  ...
  // ── camera world transform (D-9: requires propagateTransforms preamble) ──
  ...
  // ── projection: branch on camera discriminant ──
