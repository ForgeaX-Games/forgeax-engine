...
export interface RendererInstallError {
...
export interface Renderer {
   ...
   */
  // biome-ignore lint/suspicious/noExplicitAny: GPU store is runtime-owned and opaque at the public seam.
  readonly store: any;
  /**
 ...
 * public surface (the explicit `./internal` export is locked in package.json).
 */
/**
