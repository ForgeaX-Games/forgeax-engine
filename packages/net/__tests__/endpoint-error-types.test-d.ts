...
// Verifies that EndpointErrorCode is a closed 4-member union and that
...
test('EndpointErrorCode is a 4-member closed union', () => {
  type ExpectedCodes = 'peer-not-found' | 'connection-closed' | 'send-failed' | 'already-closed';
