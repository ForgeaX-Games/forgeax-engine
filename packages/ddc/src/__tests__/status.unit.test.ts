...
describe('DDC versioned status envelope', () => {
  const status: DdcStatus = {
    ...
    health: 'blocked',
    gameDir: '/Users/you/game',
    projectDdcRoot: '/Users/you/game/.forgeax/ddc/v2',
    layers: [
      {
        kind: 'project',
        owner: 'engine-ddc',
        ...
        actions: [
          {
            kind: 'prune',
            executable: true,
            exactTarget: '/Users/you/game/.forgeax/ddc/v2/generations/4',
          },
        ],
      },
    ],
  ...
  it('redacts every host path from browser projection while preserving recovery data', () => {
    ...
    expect(text).not.toContain('/Users/you');
